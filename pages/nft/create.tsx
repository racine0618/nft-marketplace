...
const NftCreate: NextPage = () => {
  ...
  const [nftMeta, setNftMeta] = useState<NftMeta>({
    ...
    image: "",
    attributes: [
      {trait_type: "品质", value: "橙色"},
      {trait_type: "级别", value: "1级"},
      {trait_type: "五行", value: "金"},
    ]
  });
    ...
    <BaseLayout>
      <div>
        <div className="py-4">
          { !nftURI &&
            <div className="flex">
              <div className="mr-2 font-bold underline">你已经有NFT了吗?</div>
              <Switch
                checked={hasURI}
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">下一步</h3>
                ...
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                  ...
                  { nftURI &&
                    <div className='mb-4 p-4'>
                      <div className="font-bold">你的元数据: </div>
                      <div>
                        <Link href={nftURI}>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">创建您的NFT</h3>
              <p className="mt-1 text-sm text-gray-600">
                这些信息将公开显示，请小心分享你的内容。
              </p>
            </div>
              ...
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  { nftMeta.image ?
                    ...
                    <div>
                    <label className="block text-sm font-medium text-gray-700">NFT图像</label>
